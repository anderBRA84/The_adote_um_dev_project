...
>
    <div class="flex flex-row items-center justify-between w-full">
        <a href="{{ route('app.profile') }}" class="cursor-pointer transform duration-150 active:scale-95">
    ...
    >
        ...
        >
            <template
                ...
                /var/www/html/adote-um-dev/routes/web.php
                /var/www/html/adote-um-dev/resources/js/components/start-form.js
                /var/www/html/adote-um-dev/resources/js/components/swipe-card.js
                /var/www/html/adote-um-dev/resources/js/components/index.js
                /var/www/html/adote-um-dev/resources/views/livewire/components/developers-screen.blade.php
                            >
                <div
                    :key="`dev${dev.id}`"
                    :id="`dev${dev.id}`"
